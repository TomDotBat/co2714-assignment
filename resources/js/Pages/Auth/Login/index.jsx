                ...
                >
                    ...
                    <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                        ...
                        <Grid container spacing={{ xs: 2, md: 3 }} justifyContent="space-evenly">
                            <Grid item>
                                <IconButton component={InertiaLink} href="/login/google">
                                    <Google/>
                                </IconButton>
                            </Grid>
                            <Grid item>
                                <IconButton component={InertiaLink} href="/login/discord">
                            ...
                            <Grid item>
                                <IconButton component={InertiaLink} href="/login/github">
                                    <GitHub/>
                                </IconButton>
                            </Grid>
                        </Grid>
                        <Grid container justifyContent="center">
                            <Grid item>
                                <Link component={InertiaLink} href="/register" variant="body2">
